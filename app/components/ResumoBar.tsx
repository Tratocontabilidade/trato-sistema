...
export function ResumoBar({ total, ok, preenchidos, inferidos, revisar, divergentes, duvidas }: ResumoBarProps) {
  return (
    <div className="resumo" role="status">
      ...
      <div className="resumo-item resumo-item--inferido">
        <div className="resumo-valor">{inferidos.toLocaleString("pt-BR")}</div>
        <div className="resumo-rotulo">NCM inferido — revisar</div>
      </div>
